...
spark = SparkSession.builder.appName("QUERY 3 WITH CATALYST OPTIMIZER CHOSEN JOINS").getOrCreate()
...
df1=df1.join(df2,["LAT","LON"], "inner")
...
df1=df1.join(df3,col("ZIPcode")==col("Zip Code"),"inner") #join
